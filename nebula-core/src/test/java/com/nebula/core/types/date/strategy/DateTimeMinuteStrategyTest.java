...
class DateTimeMinuteStrategyTest {
	...
	void getByDateAndIndexAndInterval_should_return_the_initial_date_for_index_0() {
		...
		// GIVEN
		DateTimeStrategy adder = new DateTimeMinuteStrategy();
	...
	void getByDateAndIndexAndInterval_should_return_the_initial_plus_1_milisecond_date_for_index_1() {
		...
		// THEN
		assertThat(result).isEqualTo(new DateTime(2017, 1, 1, 0, 1, 0, 0));
	}
	...
	void getMaxIndex_should_return_10() {
		...
		DateTime max = new DateTime(2017, 1, 1, 0, 10, 0, 0);
	...
	void getMaxIndex_should_return_1() {
		...
		DateTimeStrategy strategy = new DateTimeMinuteStrategy();
		DateTime min = new DateTime(2017, 1, 1, 0, 0, 0, 0);
		DateTime max = new DateTime(2017, 1, 1, 0, 1, 0, 0);
