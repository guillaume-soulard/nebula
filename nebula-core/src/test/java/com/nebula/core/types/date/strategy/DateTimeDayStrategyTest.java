...
public class DateTimeDayStrategyTest {
	...
	public void getByDateAndIndexAndInterval_should_return_the_initial_plus_1_milisecond_date_for_index_1() {
		...
		// THEN
		assertThat(result).isEqualTo(new DateTime(2017, 1, 2, 0, 0, 0, 0));
	}
	...
	public void getMaxIndex_should_return_10() {
		...
		// GIVEN
		DateTimeStrategy strategy = new DateTimeDayStrategy();
		DateTime min = new DateTime(2017, 1, 1, 0, 0, 0, 0);
		DateTime max = new DateTime(2017, 1, 11, 0, 0, 0, 0);
	...
	public void getMaxIndex_should_return_1() {
		...
		DateTimeStrategy strategy = new DateTimeDayStrategy();
		DateTime min = new DateTime(2017, 1, 1, 0, 0, 0, 0);
		DateTime max = new DateTime(2017, 1, 2, 0, 0, 0, 0);
